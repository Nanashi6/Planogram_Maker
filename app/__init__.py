...
from app.blueprints.categoryRules import category_rules_bp
from app.blueprints.shelfRules import shelf_rules_bp
from app.blueprints.rules import rules_bp
...
app.register_blueprint(shelf_rules_bp)
